// components/dev/EventCardComponent.js
...
export class EventCardComponent {
    ...
    template.innerHTML = `
      <div class="dev-card">
        <div class="dev-card-info">
          <div data-field="name" class="dev-event-data">
            ${this.eventData.name || "Internal name no disponible"}
          </div>
          <div class="filters-separator"></div>
          <div data-field="title" class="dev-event-data">
            ${this.eventData.title || "Public name no disponible"}
          </div>
          <div class="filters-separator"></div>
          <div class="dev-event-data">Fecha: ${formattedDate || "Fecha no disponible"}</div>
          <div class="filters-separator"></div>
          <div data-field="active" class="dev-event-data">
            ${this.eventData.active ? "Activo" : "Inactivo"}
          </div>
          <div class="filters-separator"></div>
          <div data-field="recurrent" class="dev-event-data">
            ${this.eventData.recurrent ? "Recurrente" : "No recurrente"}
          </div>
        </div>
  ...
  /**
   * Método para asignar una acción al botón de eliminar
   * (Por ejemplo, llamar a deleteEvent en el adapter)
   */
  setDeleteAction(action) {
    const deleteButton = this.element.querySelector(".dev-delete");
    if (deleteButton) {
      // Cuando se hace click en "Eliminar", llamamos la acción
